 ...
 * @author TRANTATDAT
 */
@WebServlet(name = "OrderDetailAdminServlet", urlPatterns = {"/admin/order-detail"})
public class OrderDetailAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            OtherAddress otherAddress = new OtherAddressDao().getOtherAddressByOrderId(orderId);
            List<OrdersDetails> listOrderDetail = new OrdersDetailsDao().getDetailsOfOrder(orderId);
